...
feature_layers = {
    ...
    '14.5': [['C', 1, 128, (3,3), 1, 1, 1, 'ReLU_NoB2d'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU_NoB2d'], ['C', 256, 256, (3,3), 1, 1, 1, 'ReLU_NoB2d'], ['C', 256, 512, (3,3), 1, 1, 1, 'ReLU_NoB2d'], 
    ['M', (2,2), 2, 0], ['C', 512, 128, (1,1), 1, 1, 0, 'ReLU_NoB2d'], ['C', 128, 128, (3,3), 1, 1, 1, 'ReLU_NoB2d'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU_NoB2d'], ['C', 256, 512, (3,3), 1, 1, 1, 'ReLU_NoB2d'], 
    ['M', (2,2), 2, 0], ['C', 512, 128, (1,1), 1, 1, 0, 'ReLU_NoB2d'], ['C', 128, 128, (3,3), 1, 1, 1, 'ReLU_NoB2d'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU_NoB2d'], ['C', 256, 512, (3,3), 1, 1, 1, 'ReLU_NoB2d'], 
    ['M', (2,2), 2, 0], ['C', 512, 128, (1,1), 1, 1, 0, 'ReLU_NoB2d'], ['C', 128, 128, (3,3), 1, 1, 1, 'ReLU_NoB2d'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU_NoB2d'], ['C', 256, 512, (3,3), 1, 1, 1, 'ReLU_NoB2d'], 
    ['M', (2,2), 2, 0]],
}
