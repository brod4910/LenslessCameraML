...
feature_layers = {
    ...
    '1.5': [['C', 1, 2, (3,3), 1, 1, 1, 'ReLU'], 
    ['M', (2,2), 2, 0], ['C', 2, 3, (3,3), 1, 1, 1, 'ReLU'], 
    ['M', (2,2), 2, 0], ['C', 3, 4, (3,3), 1, 1, 1, 'ReLU']],
    ...
    '14.5': [['C', 1, 64, (3,3), 1, 1, 1, 'ReLU'], ['C', 64, 128, (3,3), 1, 1, 1, 'ReLU'], ['C', 128, 128, (3,3), 1, 1, 1, 'ReLU'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU'], 
    ['M', (2,2), 2, 0], ['C', 256, 64, (1,1), 1, 1, 0, 'ReLU'], ['C', 64, 64, (3,3), 1, 1, 1, 'ReLU'], ['C', 64, 128, (3,3), 1, 1, 1, 'ReLU'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU'], 
    ['M', (2,2), 2, 0], ['C', 256, 64, (1,1), 1, 1, 0, 'ReLU'], ['C', 64, 64, (3,3), 1, 1, 1, 'ReLU'], ['C', 64, 128, (3,3), 1, 1, 1, 'ReLU'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU'], 
    ['M', (2,2), 2, 0], ['C', 256, 64, (1,1), 1, 1, 0, 'ReLU'], ['C', 64, 64, (3,3), 1, 1, 1, 'ReLU'], ['C', 64, 128, (3,3), 1, 1, 1, 'ReLU'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU'], 
    ['M', (2,2), 2, 0]],

    '15': [['C', 1, 32, (3,3), 1, 1, 1, 'ReLU'], ['C', 32, 64, (3,3), 1, 1, 1, 'ReLU'], ['C', 64, 128, (3,3), 1, 1, 1, 'ReLU'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU'], 
    ['M', (2,2), 2, 0], ['C', 256, 32, (1,1), 1, 1, 0, 'ReLU'], ['C', 32, 64, (3,3), 1, 1, 1, 'ReLU'], ['C', 64, 128, (3,3), 1, 1, 1, 'ReLU'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU'],
    ['M', (2,2), 2, 0]],

    '16': [['C', 1, 32, (3,3), 1, 1, 1, 'ReLU'], ['C', 32, 64, (3,3), 1, 1, 1, 'ReLU'], ['C', 64, 128, (3,3), 1, 1, 1, 'ReLU'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU'], 
    ['M', (2,2), 2, 0], ['C', 256, 32, (1,1), 1, 1, 0, 'ReLU'], ['C', 32, 64, (3,3), 1, 1, 1, 'ReLU'], ['C', 64, 128, (3,3), 1, 1, 1, 'ReLU'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU'],
    ['M', (2,2), 2, 0], ['C', 256, 32, (1,1), 1, 1, 0, 'ReLU'], ['C', 32, 64, (3,3), 1, 1, 1, 'ReLU'], ['C', 64, 128, (3,3), 1, 1, 1, 'ReLU'], ['C', 128, 256, (3,3), 1, 1, 1, 'ReLU'],
    ['M', (2,2), 2, 0]],
}
...
classifier_layers = {
    ...
    '1.5': [['L', 4 * 7 * 7, 10, 'ReLU'], ['D', .5], ['FC', 10, 10]],
    ...
    '14': [['L', 512 * 15 * 15, 2048, 'ReLU'], ['D', .5],['FC', 2048, 10]],
    '14.5': [['L', 256 * 15 * 15, 2048, 'ReLU'], ['D', .5], ['FC', 2048, 10]],
    '15': [['L', 256 * 12 * 12, 698, 'ReLU'], ['FC', 698, 10]],
    '16': [['L', 256 * 6 * 6, 698, 'ReLU'], ['FC', 698, 10]],
}
