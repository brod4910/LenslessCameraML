...
feature_layers = {
	'1': [['C', 1, 128, (3,3), 1, 1], ['M', (2,2), 2, 0], ['C', 128, 256, (3,3), 1, 1], ['M', (2,2), 2, 0], ['C', 256, 512, (3,3), 1, 1], ['M', (2,2), 2, 0], ['C', 512, 256, (3,3), 1, 1], ['M', (2,2), 2, 0]],
...
classifier_layers = {
	...
	'2': [['L', 512 * 10 * 10, 1024], ['D'], ['L', 1024, 2048], ['D'], ['FC', 2048, 5]]
}
...
def main():
	...
	network = model.Model(model.make_layers(feature_layers['2']), model.make_classifier_layers(classifier_layers['2'])).to(device)
