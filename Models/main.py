...
feature_layers = {
    ...
    '7': [['C', 1, 128, (3,3), 1, 1, 'SELU'], ['C', 128, 128, (3,3), 1, 1, 'SELU'], ['C', 128, 256, (3,3), 1, 1, 'SELU'], ['C', 256, 256, (3,3), 1, 1, 'SELU'], ['C', 256, 256, (3,3), 1, 1, 'SELU'], ['C', 256, 64, (1,1), 1, 0, 'None'], ['C', 64, 128, (3,3), 2, 0, 'SELU'],
    ['C', 128, 128, (3,3), 1, 1, 'SELU'], ['C', 128, 256, (3,3), 1, 1, 'SELU'], ['C', 256, 256, (3,3), 1, 1, 'SELU'], ['C', 256, 256, (3,3), 1, 1, 'SELU'], ['M', (2,2), 2, 0],
    ['C', 128, 128, (3,3), 1, 1, 'SELU'], ['C', 128, 256, (3,3), 1, 1, 'SELU'], ['C', 256, 256, (3,3), 1, 1, 'SELU'], ['C', 256, 256, (3,3), 1, 1, 'SELU'], ['C', 256, 64, (1,1), 1, 0, 'None'], ['C', 64, 128, (3,3), 2, 0, 'SELU'],
    ['C', 128, 128, (3,3), 1, 1, 'SELU'], ['C', 128, 256, (3,3), 1, 1, 'SELU'], ['C', 256, 256, (3,3), 1, 1, 'SELU'], ['C', 256, 256, (3,3), 1, 1, 'SELU'], ['M', (2,2), 2, 0]]
}

classifier_layers = {
    '1': [['L', 256 * 40 * 30, 1024, 'ReLU'], ['D', .5], ['FC', 1024, 5]],
    '2': [['L', 512 * 10 * 10, 1024, 'ReLU'], ['D', .5], ['L', 1024, 2048, 'ReLU'], ['D', .5], ['FC', 2048, 10]],
