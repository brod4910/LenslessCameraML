...
feature_layers = {
	...
	'1':[
		...
		[[['M', (2,2), 2, 0], ['C', 1392, 384, (1,1), 1, 0, 'None']], [['C', 1392, 384, (1,1), 1, 0, 'None'], ['C', 384, 384, (3,3), 2, 0, 'ReLU']], [['C', 1392, 384, (1,1), 1, 0, 'None'], ['C', 384, 384, (3,3), 2, 0, 'ReLU']]], 
...
classifier_layers = {
	...
	'1': [['L', 512 * 7 * 7, 1024, 'ReLU'], ['D', .7], ['L', 1024, 2048, 'ReLU'], ['D', .7], ['FC', 2048, 10]]
}